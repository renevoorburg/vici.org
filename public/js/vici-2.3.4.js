...
/**
 ...
 2.3.1: 2018-06-07
 - moved id up from properties in GeoJSON
 - fixed baseUrl code

 2.3.2: 2018-06-10
 - options.zoomlevel will override session (but not url)

 2.3.3: 2018-06-14
 - forces that the map element has relative positioning (returned feature from the 1.x series)

 2.3.4: 2018-06-24
 - options.filter will override session
