...
/**
 ...
 2.2.1: 2018-05-31
 - cleaned some declaration stuff related to highlights[]

 2.3.0: 2018-06-07
 - add: consumes geojson
 - removed 'numeric' param in ajax request
        ...
        function setFeatures(d) {
            ...
            for (let i in d.features) {
                ...
                if (feature.geometry.type === "GeometryCollection") {
                    ...
                    if (!vectorSourceLines.getFeatureById(feature.properties.id)) {
                        // new line:
                        ...
                        lineFeature.setId(feature.properties.id);
                        lineFeature.setStyle(lineStyles[feature.properties.line.kind]);
                        vectorSourceLines.addFeature(lineFeature);

                    } else if (vectorSourceLines.getFeatureById(feature.properties.id).vici.expire <= session.zoomlevel) {
                        // existing line, update geometry:
                        let lineFeature = vectorSourceLines.getFeatureById(feature.properties.id);
