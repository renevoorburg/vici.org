...
function ViciWidget(element, options) {
    ...
    function getHighlights() {
        ...
        if (mapState.numHighlights > 0) {
            ...
            var requrl = baseUrl + "/highlight.php?numeric" + mapState.perspectiveParam + "&bounds=" + bounds + "&zoom=" + zoomlevel + "&n=" + mapState.numHighlights + "&era=" + session.filter.era + "&visibility=" + session.filter.visibility + mapState.langReq;
