...
<head>
    ...
    <?php if (preg_match("/\.dev$/i", $_SERVER['HTTP_HOST'])) {
        ...
        echo '<script type="text/javascript" src="/js/vici-1.3.0.js"></script>';
    } else {
        echo '<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js" ></script>',"\n";
        echo '    <script type="text/javascript" src="http://vici.org/js/vici-1.3.0.min.js"></script>';
    } ?>
</head>
...
// a more complex call, overriding some defaults:
var mapObj = new ViciWidget(document.getElementById('map'),
    {"mapTypeId": "HYBRID",
     "mapOverlays" : [{"name": "IMPERIUM", "opacity": 0.8}],
