...
{block name=main}
    ...
    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); display: flex; justify-content: center; align-items: center; z-index: 1000;">
        <div style="margin: auto; border: 1px solid #ccc; padding: 2rem; border-radius: 0.5rem; box-shadow: 0 0.25rem 0.375rem rgba(0, 0, 0, 0.1); background-color: white; max-width: 31.25rem; width: 100%;">
