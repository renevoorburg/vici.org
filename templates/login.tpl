...
{block name=main}
    <main>
        <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); display: flex; justify-content: center; align-items: center; z-index: 1000;">
            ...
            <h1 style="font-size: 1.5rem; color: #1e3a8a; margin-bottom: 1rem;">{$login_title_label|default:"Login"}</h1>
                {if $message}
                ...
                <form action="" method="post" style="display: flex; flex-direction: column; gap: 1rem;">
                    <div style="display: grid; grid-template-columns: auto 1fr; gap: 0.75rem; align-items: center;">
                        <label for="frm_accountname" style="color: #374151;">{$account_name_label|default:"Account name"}:</label>
                        ...
                        <label for="frm_password" style="color: #374151;">{$password_label|default:"Password"}:</label>
                    ...
                    <div style="margin-top: 0.5rem;">
                        <input type="submit" value="{$login_title_label}" style="background-color: #1e3a8a; color: white; border: none; border-radius: 0.25rem; padding: 0.5rem 1rem; font-size: 1rem; cursor: pointer;">
                    </div>
                </form>
            </div>
        </div>
